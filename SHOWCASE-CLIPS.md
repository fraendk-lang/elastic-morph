# Showcase-Clips — 3 Pakete produzieren
...
## Clip 2 — Spotify Canvas (1:1 · 8s Loop)
...
## Clip 3 — YouTube / Landing (16:9 · 30s)
...
- [ ] 1 Clip mit **From Elastic Morph** Banner in Post-Ready getestet

---

## Nach Produktion

1. Clips in `assets/showcase/` ablegen (optional, lokal)
2. [`FREMDTEST.md`](FREMDTEST.md) mit echtem Tester durchführen
3. Besten Clip auf Landing / Social als Hero posten
